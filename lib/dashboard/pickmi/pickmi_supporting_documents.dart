...
class SupportingDocuments extends StatefulWidget {
  @override
  _SupportingDocumentsState createState() => _SupportingDocumentsState();
}
...
class _SupportingDocumentsState extends State<SupportingDocuments> {
  ...
  var _listText = [
    "- Kartu Keluarga",
    "- STNK / SIM / NPWP",
    "- Bukti Tagihan PAM / Listrik / TV Cable / Telepon",
    "- Dokumen lain dengan nama dan alamat sesuai eKTP"
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          elevation: 0.0,
          title: Text("Dokumen Pendukung", style: Theme.of(context).textTheme.title),
        ),
        body: Container(
          color: Colors.white,
