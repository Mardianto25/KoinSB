...
class ProofOfIncome extends StatefulWidget {
  @override
  _ProofOfIncomeState createState() => _ProofOfIncomeState();
}

class _ProofOfIncomeState extends State<ProofOfIncome> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          elevation: 0.0,
          title: Text("Bukti Pendapatan", style: Theme.of(context).textTheme.title),
        ),
        body: Container(
          color: Colors.white,
