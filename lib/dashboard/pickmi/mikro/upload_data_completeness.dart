...
class UploadDataCompleteness extends StatefulWidget {
  @override
  _UploadDataCompletenessState createState() => _UploadDataCompletenessState();
}

class _UploadDataCompletenessState extends State<UploadDataCompleteness> {
  final formKey = new GlobalKey<FormState>();
  var _address, _postalCode;
  var _listText = [
    "- E-KTP Pasangan/Penjamin, KK, Bukti Pembayaran Listrik",
    "- Foto Slip Gaji/Mutasi Rekening 3 bulan terakhir",
    "- Foto Surat Keterangan Kerja/SKU",
    "- Foto Buku Nikah/Cerai"
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          elevation: 0.0,
          title:
          Text("Upload Kelengkapan Data", style: Theme.of(context).textTheme.title),
        ),
        body: Stack(
          children: <Widget>[
                        ...
                        child: Padding(
                            ...
                            child: Form(
                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    Container(
                                      child: Text("DOKUMEN YANG MEMENUHI SYARAT",
                                ...
                                child: RichText(
                                  text: TextSpan(
                                    ...
                                    children: <TextSpan>[
                                      ...
                                      TextSpan(
                                          text:
                                          'Dokumen yang diberi tanda khusus wajib untuk di upload',
                                          style: TextStyle(
                                              fontWeight: FontWeight.bold,
                                              color: Colors.black,
                                              fontSize: 10))
