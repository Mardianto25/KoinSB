...
import 'package:flutter_base/dashboard/pickmi/pickmi_success_loan_of_goods.dart';
import 'package:flutter_base/style/custom_roundrec_button.dart';
import 'package:flutter_base/style/custom_text.dart';
import 'package:flutter_base/widget/custom_registration_button.dart';
import 'package:flutter_svg/flutter_svg.dart';

class PickmiDetailLoanOfGoods extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _PickmiDetailLoanOfGoodsState();
  }
}

class _PickmiDetailLoanOfGoodsState extends State<PickmiDetailLoanOfGoods> {
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              Container(
                                child: Container(
                                  child: Text("Asal e-Commrerce", style: CustomText.regular12Grey),
                                ),
                              ),
                              Container(
                                child: Container(
                                  child: Text("Down Payment", style: CustomText.regular12Grey),
                                ),
                              ),
                            ],
                          )  
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              Container(
                                child: Container(
                                  child: Text("Nama Ecommerce", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
                                ),
                              ),
                              Container(
                                child: Container(
                                  child: Text("Rp 000.000", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
                                ),
                              )
                            ],
                          )  
                ...
                GestureDetector(
                  onTap: () {
                    ...
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => PickmiSuccessLoanOfGoods()));
                  },
                  child: Container(
                      width: double.infinity,
                      child: Container(
