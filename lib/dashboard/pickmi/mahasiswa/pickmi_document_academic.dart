...
class PickmiDocumentAcademic extends StatefulWidget {
  @override
  _PickmiDocumentAcademicState createState() => _PickmiDocumentAcademicState();
}

class _PickmiDocumentAcademicState extends State<PickmiDocumentAcademic> {
  final formKey = new GlobalKey<FormState>();
  var _address, _postalCode;
  var _listText = [
    "- Kartu Tanda Mahasiswa",
    "- Kartu Hasil Study",
    "- Surat Keterangan Mahasiswa dari Rektorat",
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          elevation: 0.0,
          title: Text("Dokumen Akademik", style: Theme.of(context).textTheme.title),
        ),
        body: Container(
          color: Colors.white,
