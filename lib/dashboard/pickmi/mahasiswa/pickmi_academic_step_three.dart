...
class PickmiAcademicStepThree extends StatefulWidget {
  @override
  _PickmiAcademicStepThreeState createState() => _PickmiAcademicStepThreeState();
}

class _PickmiAcademicStepThreeState extends State<PickmiAcademicStepThree> {
  ...
  void initState() {
    ...
    homeStatus.add(new RadioModel(false, 'Kosan'));
                      ...
                      child: Form(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                margin: EdgeInsets.only(bottom: 12.0, top: 15),
                                child: Text(
                                  "Alamat ini akan menjadi alamat pengiriman Pinjaman PICKMI",
                                  style: CustomText.regular12,
                                ),
                              ),
                              Container(
                                padding: EdgeInsets.only(top: 10.0, bottom: 10.0),
                                child: Text("Jenis Alamat", style: CustomText.regular12,),
                              ),
                              Container(
                                height: 50.0,
