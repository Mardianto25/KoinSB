...
class PickmiDocumentSupporting extends StatefulWidget {
  @override
  _PickmiDocumentSupportingState createState() => _PickmiDocumentSupportingState();
}

class _PickmiDocumentSupportingState extends State<PickmiDocumentSupporting> {
  final formKey = new GlobalKey<FormState>();
  var _address, _postalCode;
  var _listText = [
    "- Kartu Keluarga",
    "- Surat Izin Mengemudi Motor/Mobil",
    "- Cover Buku Tabungan dengan Nama dan Alamat Terlihat",
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          elevation: 0.0,
          title: Text("Dokumen Pedukung", style: Theme.of(context).textTheme.title),
        ),
        body: Container(
          color: Colors.white,
