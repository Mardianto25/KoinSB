...
class PickmiSuccessLoanOfGoods extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => new _PickmiSuccessLoanOfGoodsState();
}

class _PickmiSuccessLoanOfGoodsState extends State<PickmiSuccessLoanOfGoods> {
