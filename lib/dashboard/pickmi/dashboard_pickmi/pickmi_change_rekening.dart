...
import 'package:flutter_base/dashboard/pickmi/dashboard_pickmi/pickmi_dashboard.dart';
...
class PickmiChangeRekening extends StatefulWidget {
  @override
  _PickmiChangeRekeningState createState() => _PickmiChangeRekeningState();
}

class _PickmiChangeRekeningState extends State<PickmiChangeRekening> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0.0,
        title: Text("Ubah Nomor Rekening", style: Theme.of(context).textTheme.title),
      ),
      body: Container(
        color: Colors.white,
