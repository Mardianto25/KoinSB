...
class PickmiChangeAddress extends StatefulWidget {
  @override
  _PickmiChangeAddressState createState() => _PickmiChangeAddressState();
}

class _PickmiChangeAddressState extends State<PickmiChangeAddress> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          elevation: 0.0,
          title: Text("Ubah Alamat Pengiriman", style: Theme.of(context).textTheme.title),
        ),
        body: Container(
          color: Colors.white,
