...
import 'pickmi_submission_approve.dart';

class PickmiAdditionalData extends StatefulWidget {
  PickmiAdditionalData({Key key, this.title}) : super(key: key);
  final String title;

  @override
  _PickmiAdditionalDataState createState() => _PickmiAdditionalDataState();
}

class _PickmiAdditionalDataState extends State<PickmiAdditionalData> {
  int _counter = 0;
  var _btnTxt = [
    "Data Pekerjaan",
    "Informasi Rekening",
    "Dokumen Pendukung",
    "Bukti Pendapatan",
    "Alamat Pengiriman Pinjaman Barang"
  ];
