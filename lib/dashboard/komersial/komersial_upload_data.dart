...
class KomersialUploadData extends StatefulWidget {
  @override
  _KomersialUploadDataState createState() => _KomersialUploadDataState();
}

class _KomersialUploadDataState extends State<KomersialUploadData> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          elevation: 0.0,
          title: Text("Upload Kelengkapan Data", style: Theme.of(context).textTheme.title),
        ),
        body: Container(
          color: Colors.white,
