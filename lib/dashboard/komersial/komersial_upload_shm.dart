...
class KomersialUploadShm extends StatefulWidget {
  @override
  _KomersialUploadShmState createState() => _KomersialUploadShmState();
}

class _KomersialUploadShmState extends State<KomersialUploadShm> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          elevation: 0.0,
          title: Text("Upload Foto SHM", style: Theme.of(context).textTheme.title),
        ),
        body: Container(
          color: Colors.white,
                          ...
                          children: <Widget>[
                            Container(
                              child: Padding(
                                ...
                                child: Text("JAMINAN SERTIFIKAT HAK MILIK", style: CustomText.regular12),
                              )
