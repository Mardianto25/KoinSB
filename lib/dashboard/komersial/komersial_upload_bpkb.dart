...
class KomersialUploadBpkb extends StatefulWidget {
  @override
  _KomersialUploadBpkbState createState() => _KomersialUploadBpkbState();
}

class _KomersialUploadBpkbState extends State<KomersialUploadBpkb> {
  final formKey = new GlobalKey<FormState>();
  var _address, _postalCode;
  var _listText = [
    "- Foto Cover BPKB",
    "- Foto Halaman 2, 3 dan 4",
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          elevation: 0.0,
          title: Text("Upload Foto BPKB", style: Theme.of(context).textTheme.title),
        ),
        body: Container(
          color: Colors.white,
                          ...
                          children: <Widget>[
                            Container(
                              child: Padding(
                                ...
                                child: Text("JAMINAN SERTIFIKAT BPKB", style: CustomText.regular12),
                              )
