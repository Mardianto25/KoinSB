...
class KomersialSummary extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _KomersialSummaryState();
  }
}

class _KomersialSummaryState extends State<KomersialSummary> {
                    ...
                    child: GestureDetector(
                      onTap: () {
                       Navigator.push(
                           context,
                           MaterialPageRoute(
                               builder: (context) => KomersialSuccess()));
                      },
                      child: Container(
