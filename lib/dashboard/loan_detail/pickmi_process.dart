...
class PickmiProcess extends StatefulWidget {
  final String title;
  PickmiProcess({Key key, @required this.title}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _PickmiProcessState(title);
  }
}

class _PickmiProcessState extends State<PickmiProcess> {
  ...
  _PickmiProcessState(String title) {
    this.title = title;
  }
                    ...
                    Container(
                      ...
                      child: RaisedButton(
                        ...
                        child: Container(
                          ...
                          child: Text("batalkan pinjaman".toUpperCase(),
                              style: TextStyle(
                                  fontSize: 15,
                ...
                Container(
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        "BELUM SELESAI",
                        style: TextStyle(color: Color(0xffd32e41), fontSize: 12, fontFamily: 'NeoSansW1GMedium'),
                      ),
                    ],
                  ),
                ),
