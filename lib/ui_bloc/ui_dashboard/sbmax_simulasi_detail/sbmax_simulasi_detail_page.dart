...
class SbmaxSimulasiDetailPage extends StatelessWidget {
  ...
  SbmaxSimulasiDetailPage({Key key, @required this.noac, @required this.list}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: MultiBlocProvider(
        providers: [
          BlocProvider(
            create: (context) {
              return SbmaxSimulasiDetailBloc(
        ...
        child: SbmaxSimulasiDetailForm(noac:noac,list: list,),
